...
# AUTHORS:      Paudel, B., & Bernstein, A. (2021).                                                         #
# PAPER:        Random walks with erasure: Diversifying personalized recommendations on social and          #
#               information networks. Web Conference 2021, 2046-2057.                                       #
#############################################################################################################
...
class RWE_D(Recommender):

    """Random Walk Algorithm.

    Parameters
    ----------
    name: string, default: 'RWE_D'
    ...
    beta: a parameter that can be used to tune the erasure probabilities. default 0.7.
    ...
    def fit(self, train_set, val_set=None):
        ...
        self.predictions = self.Model_RDW.train_RWE_ideology( beta = self.beta, iters=self.iterations)
    ...
    def score(self, user_idx, item_idx=None, **kwargs):
        ...
        score = common.roundRowScore(self.predictions[user_idx], 1, 0)
