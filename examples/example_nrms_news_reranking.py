###### Example Script: NRMS Model ######
# This script demonstrates the standard experiment of the NRMS model.
#
# 1. Data Preparation:
...
#
# 2. NRMS Model Configuration:
#    - The NRMS model utilizes user history and impression logs for training.
...
#    - Combines the NRMS model, metrics, and rerankers in a Cornac `Experiment`.
...
def main():
    ...
    output_file_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '.', 'output_nrms_reranking_result')
